...
// Toggle between light and dark only — no system state.
let toggleThemeSetting = () => {
  if (determineComputedTheme() === "light") {
...
let initTheme = () => {
  ...
  // Convert "system" to an explicit setting so the toggle is always predictable.
  if (themeSetting === "system") {
